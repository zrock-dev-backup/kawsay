% Archivo: sprint4_report.tex
% Este archivo está diseñado para ser incluido en un documento maestro de LaTeX usando \input{sprint4_report.tex}
% Asegúrese de que el documento maestro cargue los paquetes: geometry, graphicx, caption, booktabs, tabularx, H.
...
% \begin{figure}[H]
%     \centering
%     % Nota: Esta es una imagen de marcador de posición.
