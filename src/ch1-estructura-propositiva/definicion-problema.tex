...
%It is necessary to take into account a lot of data when deciding to edit the academic calendar, to change a class from one timeslot to another could create a conflict, where to classes have the same time, or a time when the teaching staff is not available.
Is necessary to considerate different dimensions when moving a course, and that's what makes it tricky, because the registrar office has to go through all those checks and evaluations in order to assess the movement of the class is actually doable.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{ishikawa-spanish.png}
